...
const translations = {
  ko: {
    ...
    printGuideFax: "팩스 방법",
    printLangTitle: "🌐 언어 설정",
    printLangDesc: "화면 상단의 지구(🌐) 아이콘을 눌러 언어를 선택해주세요.",
    printLangImg1Alt: "언어 설정 - 지구 아이콘 위치",
    printLangImg2Alt: "언어 설정 - 지구 아이콘으로 언어 선택",
    // 복사 안내 페이지
    copyPageTitle: "📄 복사 안내",
    copyHeroDesc:
      "복합기에서 문서를 복사하는 방법입니다. 원고를 올바르게 올린 뒤 옵션을 선택하고 결제하면 됩니다.",
    copyStepsTitle: "📌 복사 순서",
    copyStep1:
      "복합기 상단 원고 스캔부에 복사할 문서를 넣습니다. 복사할 면이 하늘을 향하도록(위로) 올려 놓고, 가이드에 맞춰 위치시킵니다. 호치키스 심, 스테이플 등 이물질이 들어가지 않도록 주의하세요.",
    copyStep2: "복합기 화면에서 복사 버튼을 누릅니다.",
    copyStep3:
    ...
    copyStep5: "출력물 확인 — 복합기 출력구에서 복사된 문서를 가져가세요.",
    backToPrint: "← 프린트샵 안내로 돌아가기",
    // 스캔 방법 페이지
    scanPageTitle: "스캔 SCAN",
    scanHeroDesc: "복합기에서 문서를 스캔하는 방법입니다. 이메일 스캔 또는 USB 스캔을 선택해 진행하세요.",
    scanTabEmail: "이메일 스캔",
    scanTabUsb: "USB 스캔",
    scanStepsTitle: "📌 스캔 순서",
    scanEmailStepsTitle: "📌 이메일 스캔 순서",
    scanEmailNoticeTitle: "⚠️ 주의사항",
    scanEmailNotice1: "이메일 주소를 정확히 적었는지 다시 한 번 확인해주세요.",
    scanEmailNotice2: "회사 메일 주소는 보안 정책(방화벽)으로 수신이 안 될 수 있고, 일반 메일도 스팸으로 분류될 수 있습니다. 잘 모르시는 경우 테스트로 1장만 먼저 보내 확인하면 손해를 줄일 수 있습니다.",
    scanEmailGuideAlt: "이메일 스캔 전체 가이드",
    scanPaperLoadWarn: "스캔할 용지를 복합기 상단에 넣어주세요. 호치케스나 이물질이 들어가지 않도록 주의해주세요!",
    scanPaperLoadAlt: "스캔할 용지를 복합기 상단에 넣습니다",
    scanEmailStep2: "복합기 화면에서 이메일 스캔을 선택합니다.",
    scanEmailStep2Alt: "이메일 스캔 2단계 - 이메일 스캔 선택",
    scanEmailStep3: "받을 이메일 주소를 입력합니다.",
    scanEmailStep3Alt: "이메일 스캔 3단계 - 이메일 주소 입력",
    scanEmailStep4: "흑백/컬러, 해상도, 파일형식(PDF/JPG), 단면/양면 등을 설정한 뒤 스캔(이메일) 버튼을 눌러 스캔합니다.",
    scanEmailStep4Alt: "이메일 스캔 4단계 - 설정 확인 후 스캔 시작",
    scanEmailStep5: "결제내역이 나오면 카드결제요청을 누르고, 결제 단말기에서 결제합니다.",
    scanEmailStep5Alt: "이메일 스캔 5단계 - 카드 결제 요청",
    scanEmailStep6: "스캔이 끝나면 이메일 전송을 확인합니다. (메일 수신까지 시간이 조금 걸릴 수 있어요)",
    scanStep1: "복합기 오른쪽 USB 포트에 USB 메모리를 꽂습니다.",
    scanStep2: "복합기 화면에서 USB 스캔 버튼을 누릅니다.",
    scanStep3: "흑백/컬러, 해상도, 원본 방향, 파일형식(PDF/JPG), 단면/양면, 연속스캔 등을 선택한 뒤 스캔(USB) 버튼을 눌러 스캔을 시작합니다.",
    scanStep4: "스캔이 끝나면 '종료 후 저장'을 선택하면 USB에 저장됩니다.",
    scanStep5: "결제내역이 나오면 카드결제요청 버튼을 누릅니다.",
    scanStep6: "결제 단말기에서 신용카드, 체크카드, 제로페이, 카카오페이 등으로 결제합니다.",
    // 1번 컴퓨터 다이렉트 출력 페이지
    directPageTitle: "🖨 1번 컴퓨터 다이렉트 출력 안내",
    directHeroDesc: "1번 컴퓨터에서는 결제 후 바로 출력됩니다. 핀번호 없이 사용할 수 있습니다.",
    directCheckTitle: "📋 출력 전 확인 사항",
    directCheckLead: "화면에 출력 리스트 박스(CLOPY)가 떠 있어야 합니다.",
    directTrayTitle: "⚠️ 출력 리스트 박스가 안 보일 때",
    directTrayLead: "화면 오른쪽 하단 화살표(▲)를 누르면 숨겨진 아이콘이 나옵니다. 그중 노란 아이콘(KSPCCLient)을 더블 클릭하면 출력 프로그램이 다시 실행됩니다.",
    directStepsTitle: "📌 출력 순서",
    directStep1: "프로그램에서 인쇄 버튼을 누른 뒤, 흑백/컬러 등 옵션을 설정하고 인쇄 버튼을 클릭합니다.",
    directStep2: "출력 리스트에 작업이 올라옵니다. 출력 매수와 금액을 확인하세요.",
    directStep3: "출력비용결제 / 출력 버튼을 눌러 결제를 진행합니다.",
    directStep4: "결제 — 신용카드, 삼성페이, 카카오페이, 제로페이, 티머니 등으로 결제합니다. 카드는 화면 아래 슬롯에 넣거나, 화면에 대서 터치합니다.",
    directStep5: "출력물 확인 — 복합기 출력구에서 인쇄물을 가져가세요.",
    // 2,3,4번 컴퓨터 핀번호 출력 페이지
    pinPageTitle: "🖨 2,3,4번 컴퓨터 핀번호 출력 안내",
    pinHeroDesc: "2,3,4번 컴퓨터는 PC에서 핀번호를 설정한 뒤, 복합기 화면에서 해당 핀번호를 입력해 출력하는 방식입니다. 서버에 파일이 올라가고 복합기에서 확인될 때까지 약 1분 정도 걸릴 수 있습니다.",
    pinStepsTitle: "📌 출력 순서",
    pinStep1: "프로그램에서 인쇄를 선택한 뒤, 흑백/컬러 등 옵션을 설정하고 인쇄 버튼을 누릅니다.",
    pinStep2: "아래와 같이 KAPP Client 화면에 출력 리스트가 올라옵니다.",
    pinStep3: "전체전송을 누른 뒤, 핀번호를 5자 이상 숫자로 입력합니다. (이미 다른 사람이 쓰는 번호면 입력이 안 될 수 있으니, 안 되면 번호를 바꿔서 다시 입력하세요.) 복합기에서 이 핀번호로 출력하므로 입력한 번호를 꼭 기억해 두세요.",
    pinStep4: "복합기 화면에서 인쇄 버튼을 누릅니다.",
    pinStep5: "아까 PC에서 설정한 핀번호를 입력한 뒤 확인 버튼을 눌러 주세요.",
    pinStep6: "컴퓨터에서 보낸 파일이 복합기에 도착하는 데 시간이 조금 걸릴 수 있습니다(1분 이내). 「등록된 Pin번호가 없습니다」라는 화면이 나오면 잠시 기다렸다가 다시 시도해 주세요.",
    pinStep7: "복합기로 잘 넘어오면 아래처럼 인쇄 목록에 보입니다. 리스트를 확인한 뒤 인쇄를 눌러 주세요.",
    pinStep8: "결제 — 신용카드, 삼성페이, 카카오페이, 제로페이, 티머니 등으로 결제합니다. 카드는 단말기 슬롯에 넣거나 화면에 대서 터치하세요.",
    pinStep9: "출력물 확인 — 복합기 출력구에서 인쇄물을 가져가세요.",
    // 팩스 방법 페이지
    faxPageTitle: "📠 팩스 방법",
    faxHeroDesc: "복합기에서 웹팩스로 문서를 보내는 방법입니다. 수신은 되지 않고 발신만 가능합니다. 발신번호는 02-4073-0798입니다.",
    faxStepsTitle: "📌 팩스 보내는 순서",
    faxStep1: "복합기 화면에서 웹팩스를 선택합니다.",
    faxStep2: "팩스 설정(컬러/흑백, 해상도, 면 선택, 파일 형식, 스캔 방향 등)을 확인한 뒤 팩스 버튼을 눌러 보냅니다.",
    faxStep3: "화면에 결제내역이 나오면 카드결제요청 버튼을 눌러 결제를 진행합니다.",
    faxStep4: "결제 단말기에서 신용카드, 삼성페이, 카카오페이, 제로페이, 티머니 등으로 결제합니다.",
    faxWarnTitle: "⚠️ 안내",
    faxWarn1: "팩스는 발송만 가능하며, 수신은 되지 않습니다.",
    faxWarn2: "발신번호: 02-4073-0798",
    kakaoInquiry: "카톡 문의",
    kakaoIconText: "톡",
    visitorTodayLabel: "오늘",
    visitorTotalLabel: "총 방문",
    // 메인 빨래방 안내 페이지
    ...
    // 음악 연습실
    musicPageTitle: "🎹 음악 연습실 사용 안내",
    musicHeroDesc: "건반 룸과 공실에서 편하게 연습하세요.",
    musicRoomTypesTitle: "🪗 룸 종류",
    musicRoomKeyboard: "건반 룸 – 야마하 피아노터치 88건반",
    musicRoomEmpty: "공실 – 비어 있는 연습실 (악기·보컬 등 자유 연습)",
    musicPriceTitle: "💰 요금 안내",
    musicPriceLead: "타임 요금과 쿠폰 할인 요금이 있습니다. (본인 연습 기준)",
    musicTimeRate: "타임 요금 – 7,000원",
    musicCouponCol: "쿠폰 시간",
    musicAmountCol: "요금",
    musicCoupon10: "10시간",
    musicCoupon20: "20시간",
    musicCoupon40: "40시간",
    musicCoupon60: "60시간",
    musicPrice50: "50,000원",
    musicPrice80: "80,000원",
    musicPrice120: "120,000원",
    musicPrice140: "140,000원",
    musicValidNote: "✔ 결제 후 3개월까지 사용 가능합니다.",
    musicBookingTitle: "⚠️ 예약 안내",
    musicBookingLead: "관악기, 타악기는 예약이 어려울 수 있습니다. 이용 전 카톡 문의를 권장합니다.",
    musicAmenitiesTitle: "🛋 시설 및 비품",
    musicAmenityAc: "에어컨",
    musicAmenityChair: "의자",
    musicAmenityStand: "보면대",
    musicAmenityAmp: "똘똘이 앰프",
    musicAmenityAmpNote: "(미리 요청)",
    musicAmenityWifi: "와이파이",
    musicAmenityToilet: "화장실",
    musicAmenityVent: "환풍기",
    musicAmenityAlarm: "경보기",
    musicAmenityLock: "도어락",
    musicAmenityWater: "정수기",
    musicStudioMapTitle: "🗺 스튜디오 배치도",
    musicStudioMapCap: "스튜디오 배치도",
    musicStudioMapAlt: "스튜디오 맵 - 1~4호실, 복도",
    musicInteriorTitle: "🖼 스튜디오 내부",
    musicInteriorCap: "스튜디오 내부",
    musicInteriorAlt: "스튜디오 내부 - 벽면, 커튼, 흡음재, 에어컨",
    musicLobbyTitle: "🚪 로비 / 복도",
    musicLobbyCap: "로비 / 복도",
    musicLobbyAlt: "로비 및 복도",
    musicRoomEmptyTitle: "🪑 공실 예시",
    musicRoomEmptyCap: "공실",
    musicRoomEmptyAlt: "공실 내부 - 에어컨, 보면대, 의자",
  },
  en: {
    ...
    printLangTitle: "🌐 Language",
    printLangDesc: "Tap the globe (🌐) icon at the top to select a language.",
    printLangImg1Alt: "Language setting - globe icon location",
    printLangImg2Alt: "Language setting - select a language via globe icon",
    // Copy guide page
    copyPageTitle: "📄 Copying Guide",
    copyHeroDesc:
      "How to make copies on the MFD. Place the original correctly, choose options, then pay.",
    copyStepsTitle: "📌 Copy Steps",
    copyStep1:
      "Place the document to copy on the top document glass of the MFD, face up, aligned with the guides. Avoid staples, paper clips, etc.",
    copyStep2: "Tap the Copy button on the MFD screen.",
    copyStep3:
      "Set options (color/B&W, orientation, sides, resolution, copies), then tap Copy to start scanning.",
    copyStep4:
      "Payment — When the payment screen appears, tap Card payment request, then pay at the terminal (credit card, Samsung Pay, Kakao Pay, Zero Pay, T-money, etc.).",
    copyStep5: "Pick up your copies from the output tray.",
    backToPrint: "← Back to Print Shop Guide",
    // Scan guide page
    scanPageTitle: "Scan SCAN",
    scanHeroDesc: "How to scan documents on the MFD. Choose Email Scan or USB Scan, then set options, scan, and pay.",
    scanTabEmail: "Email Scan",
    scanTabUsb: "USB Scan",
    scanStepsTitle: "📌 Scan Steps",
    scanEmailStepsTitle: "📌 Email Scan Steps",
    scanEmailNoticeTitle: "⚠️ Important Notice",
    scanEmailNotice1: "Please double-check that the email address is entered correctly.",
    scanEmailNotice2: "If you use a company email address, delivery may fail due to firewall/security policies. Even personal email can be classified as spam. If unsure, send 1 page as a test first to reduce risk.",
    scanEmailGuideAlt: "Email scan full guide",
    scanPaperLoadWarn: "Place the pages to scan on the top feeder/glass. Please remove staples and avoid foreign objects.",
    scanPaperLoadAlt: "Place the pages to scan on the top of the MFD",
    scanEmailStep2: "On the MFD screen, select Email Scan.",
    scanEmailStep2Alt: "Email scan step 2 - select Email Scan",
    scanEmailStep3: "Enter the destination email address.",
    scanEmailStep3Alt: "Email scan step 3 - enter email address",
    scanEmailStep4: "Set options (B&W/color, resolution, file format PDF/JPG, single/double-sided), then tap Scan(Email) to start.",
    scanEmailStep4Alt: "Email scan step 4 - check settings and start scanning",
    scanEmailStep5: "When the payment summary appears, tap the card payment request button and pay at the terminal.",
    scanEmailStep5Alt: "Email scan step 5 - card payment request",
    scanEmailStep6: "After scanning, check that the email was sent. (Delivery may take a moment.)",
    scanStep1: "Insert your USB drive into the USB port on the right side of the MFD.",
    scanStep2: "Tap the USB Scan button on the MFD screen.",
    scanStep3: "Set options (B&W/color, resolution, orientation, file format PDF/JPG, single/double-sided, continuous scan), then tap Scan(USB) to start.",
    scanStep4: "When scanning is done, choose 'Save after completion' to save the file to your USB.",
    scanStep5: "When the payment summary appears, tap the card payment request button.",
    scanStep6: "Pay at the terminal with credit card, debit card, Zero Pay, Kakao Pay, etc.",
    // Direct print (PC #1) page
    directPageTitle: "🖨 Direct Print Guide (PC #1)",
    directHeroDesc: "On PC #1, documents print right after payment. No PIN required.",
    directCheckTitle: "📋 Before Printing",
    directCheckLead: "The output list box (CLOPY) must be visible on the screen.",
    directTrayTitle: "⚠️ If the Output List Box Is Not Visible",
    directTrayLead: "Tap the arrow (▲) at the bottom right of the screen to show hidden icons. Double-click the yellow icon (KSPCCLient) to run the print program again.",
    directStepsTitle: "📌 Print Steps",
    directStep1: "Click Print in your program, set B&W/color options, then click Print.",
    directStep2: "The job appears in the output list. Check the number of pages and amount.",
    directStep3: "Tap the Payment / Print button to proceed with payment.",
    directStep4: "Payment — Pay with credit card, Samsung Pay, Kakao Pay, Zero Pay, T-money, etc. Insert the card in the slot or tap on the screen.",
    directStep5: "Pick up your prints from the MFD output tray.",
    // PIN print (PC #2–4) page
    pinPageTitle: "🖨 PIN Print Guide (PC #2, #3, #4)",
    pinHeroDesc: "On PCs #2–4, set a PIN on the PC, then enter that PIN on the MFD to print. It may take about 1 minute for the file to reach the MFD.",
    pinStepsTitle: "📌 Print Steps",
    pinStep1: "Select Print in your program, set B&W/color options, then click Print.",
    pinStep2: "The output list appears in the KAPP Client window.",
    pinStep3: "Tap Send all, then enter a PIN (5+ digits). If it fails, the PIN may be in use—try another. Remember the PIN; you will enter it on the MFD.",
    pinStep4: "On the MFD screen, tap Print.",
    pinStep5: "Enter the PIN you set on the PC and tap Confirm.",
    pinStep6: "It can take up to 1 minute for the file to reach the MFD. If you see \"No PIN registered,\" wait a moment and try again.",
    pinStep7: "When the job appears in the print list on the MFD, check the list and tap Print.",
    pinStep8: "Payment — Pay with credit card, Samsung Pay, Kakao Pay, Zero Pay, T-money, etc. Insert the card or tap on the terminal.",
    pinStep9: "Pick up your prints from the MFD output tray.",
    // Fax guide page
    faxPageTitle: "📠 Fax Guide",
    faxHeroDesc: "How to send documents via web fax on the MFD. Incoming fax is not supported; outgoing only. Outgoing number: 02-4073-0798.",
    faxStepsTitle: "📌 How to Send a Fax",
    faxStep1: "Select Web Fax on the MFD screen.",
    faxStep2: "Check fax settings (color/B&W, resolution, sides, file format, scan direction, etc.), then tap Fax to send.",
    faxStep3: "When the payment summary appears, tap the card payment request button to pay.",
    faxStep4: "Pay at the terminal with credit card, Samsung Pay, Kakao Pay, Zero Pay, T-money, etc.",
    faxWarnTitle: "⚠️ Note",
    faxWarn1: "Only sending is supported; incoming fax is not available.",
    faxWarn2: "Outgoing number: 02-4073-0798",
    kakaoInquiry: "KakaoTalk",
    kakaoIconText: "Talk",
    visitorTodayLabel: "Today",
    visitorTotalLabel: "Total",
    ...
    // Music studio
    musicPageTitle: "🎹 Music Studio Guide",
    musicHeroDesc: "Practice comfortably in our keyboard room or empty rooms.",
    musicRoomTypesTitle: "🪗 Room Types",
    musicRoomKeyboard: "Keyboard room – Yamaha piano touch 88 keys",
    musicRoomEmpty: "Empty room – For instruments, vocal practice, etc.",
    musicPriceTitle: "💰 Pricing",
    musicPriceLead: "Time rate and coupon discounts (personal practice).",
    musicTimeRate: "Time rate – 7,000 KRW",
    musicCouponCol: "Coupon hours",
    musicAmountCol: "Amount",
    musicCoupon10: "10 hrs",
    musicCoupon20: "20 hrs",
    musicCoupon40: "40 hrs",
    musicCoupon60: "60 hrs",
    musicPrice50: "50,000 KRW",
    musicPrice80: "80,000 KRW",
    musicPrice120: "120,000 KRW",
    musicPrice140: "140,000 KRW",
    musicValidNote: "✔ Valid for 3 months after payment.",
    musicBookingTitle: "⚠️ Booking",
    musicBookingLead: "Wind and percussion instruments may be hard to book. We recommend contacting us via KakaoTalk before visiting.",
    musicAmenitiesTitle: "🛋 Facilities & Amenities",
    musicAmenityAc: "Air conditioning",
    musicAmenityChair: "Chairs",
    musicAmenityStand: "Music stand",
    musicAmenityAmp: "Amp (Ddolddoli)",
    musicAmenityAmpNote: "(Request in advance)",
    musicAmenityWifi: "Wi‑Fi",
    musicAmenityToilet: "Toilet",
    musicAmenityVent: "Ventilation",
    musicAmenityAlarm: "Alarm",
    musicAmenityLock: "Door lock",
    musicAmenityWater: "Water purifier",
    musicStudioMapTitle: "🗺 Studio Map",
    musicStudioMapCap: "Studio map",
    musicStudioMapAlt: "Studio map – Rooms 1–4, corridor",
    musicInteriorTitle: "🖼 Studio Interior",
    musicInteriorCap: "Studio interior",
    musicInteriorAlt: "Studio interior – walls, curtain, acoustic panels, AC",
    musicLobbyTitle: "🚪 Lobby / Corridor",
    musicLobbyCap: "Lobby / Corridor",
    musicLobbyAlt: "Lobby and corridor",
    musicRoomEmptyTitle: "🪑 Empty Room",
    musicRoomEmptyCap: "Empty room",
    musicRoomEmptyAlt: "Empty room – AC, music stand, chair",
  },
  zh: {
    siteTitle: "多店使用指南",
    navHome: "首页",
    ...
    printGuideFax: "传真指南",
    printLangTitle: "🌐 语言设置",
    printLangDesc: "点击画面上方的地球(🌐)图标选择语言。",
    printLangImg1Alt: "语言设置 - 地球图标位置",
    printLangImg2Alt: "语言设置 - 通过地球图标选择语言",
    // 复印指南页面
    copyPageTitle: "📄 复印指南",
    copyHeroDesc: "在复合机上复印文档。请正确放置原稿、选择选项后付款即可。",
    copyStepsTitle: "📌 复印顺序",
    copyStep1:
      "将待复印文档放在复合机顶部原稿扫描台上，复印面朝上，对准导板。注意不要放入订书钉、回形针等异物。",
    copyStep2: "在复合机屏幕上按「复印」按钮。",
    copyStep3:
      "选择彩色/黑白、原稿方向、面、分辨率、份数等选项后，按「复印」开始扫描。",
    copyStep4:
      "付款 — 画面显示结账信息后按「卡支付请求」，在终端用信用卡、三星支付、Kakao Pay、Zero Pay、T-money等支付。",
    copyStep5: "在复合机出纸口取走复印好的文档。",
    backToPrint: "← 返回打印店指南",
    // 扫描指南页面
    scanPageTitle: "扫描 SCAN",
    scanHeroDesc: "复合机扫描文档的方法。请选择邮件扫描或USB扫描，设置选项后进行扫描并付款。",
    scanTabEmail: "邮件扫描",
    scanTabUsb: "USB扫描",
    scanStepsTitle: "📌 扫描顺序",
    scanEmailStepsTitle: "📌 邮件扫描顺序",
    scanEmailNoticeTitle: "⚠️ 注意事项",
    scanEmailNotice1: "请再次确认邮箱地址填写是否正确。",
    scanEmailNotice2: "使用公司邮箱时，可能会因防火墙/安全策略导致无法接收；普通邮箱也可能被归类为垃圾邮件。如不确定，建议先测试发送1页以减少损失。",
    scanEmailGuideAlt: "邮件扫描完整指南",
    scanPaperLoadWarn: "请将要扫描的纸张放在复合机上方。注意去除订书钉等异物！",
    scanPaperLoadAlt: "将要扫描的纸张放在复合机上方",
    scanEmailStep2: "在复合机画面上选择「邮件扫描」。",
    scanEmailStep2Alt: "邮件扫描第2步 - 选择邮件扫描",
    scanEmailStep3: "输入接收邮箱地址。",
    scanEmailStep3Alt: "邮件扫描第3步 - 输入邮箱地址",
    scanEmailStep4: "设置黑白/彩色、分辨率、文件格式(PDF/JPG)、单面/双面后，点击「扫描(邮件)」开始扫描。",
    scanEmailStep4Alt: "邮件扫描第4步 - 确认设置并开始扫描",
    scanEmailStep5: "出现结账信息后按「卡支付请求」，并在终端完成支付。",
    scanEmailStep5Alt: "邮件扫描第5步 - 卡支付请求",
    scanEmailStep6: "扫描结束后请确认邮件是否已发送。（收件可能需要一点时间）",
    scanStep1: "将U盘插入复合机右侧的USB接口。",
    scanStep2: "在复合机画面上按「USB扫描」按钮。",
    scanStep3: "选择黑白/彩色、分辨率、原稿方向、文件格式(PDF/JPG)、单面/双面、连续扫描等后，按「扫描(USB)」开始扫描。",
    scanStep4: "扫描结束后选择「结束并保存」即可保存到U盘。",
    scanStep5: "出现结账信息后按「卡支付请求」按钮。",
    scanStep6: "在支付终端使用信用卡、借记卡、Zero Pay、Kakao Pay等支付。",
    // 1号电脑直接打印页面
    directPageTitle: "🖨 1号电脑直接打印指南",
    directHeroDesc: "1号电脑支付后即可直接打印，无需输入PIN码。",
    directCheckTitle: "📋 打印前确认",
    directCheckLead: "画面需显示输出列表窗口(CLOPY)。",
    directTrayTitle: "⚠️ 看不到输出列表时",
    directTrayLead: "点击画面右下角箭头(▲)可显示隐藏图标，双击黄色图标(KSPCCLient)可重新打开打印程序。",
    directStepsTitle: "📌 打印顺序",
    directStep1: "在程序中点击打印，设置黑白/彩色等选项后点击打印。",
    directStep2: "任务会出现在输出列表中，请确认张数和金额。",
    directStep3: "点击「输出费用结算/输出」按钮进行结账。",
    directStep4: "付款 — 使用信用卡、三星支付、Kakao Pay、Zero Pay、T-money等支付。将卡插入下方插槽或贴近画面感应。",
    directStep5: "在复合机出纸口取走打印件。",
    // 2、3、4号电脑PIN码打印页面
    pinPageTitle: "🖨 2、3、4号电脑PIN码打印指南",
    pinHeroDesc: "2、3、4号电脑需在PC上设置PIN码后，在复合机画面输入该PIN码打印。文件上传至服务器并在复合机显示可能需要约1分钟。",
    pinStepsTitle: "📌 打印顺序",
    pinStep1: "在程序中选择打印，设置黑白/彩色等选项后点击打印。",
    pinStep2: "KAPP Client画面会显示输出列表。",
    pinStep3: "点击「全部发送」后输入5位以上PIN码。（若该号码已被使用可能无法输入，请更换号码重试。）复合机将凭此PIN码打印，请牢记。",
    pinStep4: "在复合机画面上按「打印」按钮。",
    pinStep5: "输入在PC上设置的PIN码后按「确认」。",
    pinStep6: "从电脑发送到复合机可能需要约1分钟。若出现「未注册PIN码」请稍候再试。",
    pinStep7: "文件到达后会在复合机打印列表中显示，确认后按「打印」。",
    pinStep8: "付款 — 使用信用卡、三星支付、Kakao Pay、Zero Pay、T-money等支付。将卡插入终端或贴近画面。",
    pinStep9: "在复合机出纸口取走打印件。",
    // 传真指南页面
    faxPageTitle: "📠 传真指南",
    faxHeroDesc: "在复合机上通过网络传真发送文档的方法。仅支持发送，不支持接收。发送号码：02-4073-0798。",
    faxStepsTitle: "📌 发送传真顺序",
    faxStep1: "在复合机画面上选择「网络传真」。",
    faxStep2: "确认传真设置（彩色/黑白、分辨率、面、文件格式、扫描方向等）后按「传真」发送。",
    faxStep3: "画面出现结账信息后按「卡支付请求」进行支付。",
    faxStep4: "在支付终端使用信用卡、三星支付、Kakao Pay、Zero Pay、T-money等支付。",
    faxWarnTitle: "⚠️ 说明",
    faxWarn1: "传真仅支持发送，不支持接收。",
    faxWarn2: "发送号码：02-4073-0798",
    kakaoInquiry: "卡卡奥咨询",
    kakaoIconText: "咨询",
    visitorTodayLabel: "今日",
    visitorTotalLabel: "总访问",
    // 主洗衣房指南页面
    ...
    // 音乐练习室
    musicPageTitle: "🎹 音乐练习室使用指南",
    musicHeroDesc: "在键盘房或空房内舒适练习。",
    musicRoomTypesTitle: "🪗 房间类型",
    musicRoomKeyboard: "键盘房 – 雅马哈钢琴触感88键",
    musicRoomEmpty: "空房 – 空练习室（乐器、声乐等自由练习）",
    musicPriceTitle: "💰 费用说明",
    musicPriceLead: "按时计费与优惠券价格。（个人练习为准）",
    musicTimeRate: "按时计费 – 7,000韩元",
    musicCouponCol: "券时长",
    musicAmountCol: "金额",
    musicCoupon10: "10小时",
    musicCoupon20: "20小时",
    musicCoupon40: "40小时",
    musicCoupon60: "60小时",
    musicPrice50: "50,000韩元",
    musicPrice80: "80,000韩元",
    musicPrice120: "120,000韩元",
    musicPrice140: "140,000韩元",
    musicValidNote: "✔ 付款后3个月内有效。",
    musicBookingTitle: "⚠️ 预约说明",
    musicBookingLead: "管乐、打击乐预约可能较难。建议使用前通过 KakaoTalk 咨询。",
    musicAmenitiesTitle: "🛋 设施与用品",
    musicAmenityAc: "空调",
    musicAmenityChair: "椅子",
    musicAmenityStand: "谱架",
    musicAmenityAmp: "扩音器（需提前预约）",
    musicAmenityAmpNote: "（需提前预约）",
    musicAmenityWifi: "无线网络",
    musicAmenityToilet: "卫生间",
    musicAmenityVent: "换气",
    musicAmenityAlarm: "警报器",
    musicAmenityLock: "门锁",
    musicAmenityWater: "净水器",
    musicStudioMapTitle: "🗺 录音室布局",
    musicStudioMapCap: "录音室布局",
    musicStudioMapAlt: "录音室布局 - 1~4号室、走廊",
    musicInteriorTitle: "🖼 录音室内部",
    musicInteriorCap: "录音室内部",
    musicInteriorAlt: "录音室内部 - 墙面、窗帘、吸音、空调",
    musicLobbyTitle: "🚪 大厅 / 走廊",
    musicLobbyCap: "大厅 / 走廊",
    musicLobbyAlt: "大厅及走廊",
    musicRoomEmptyTitle: "🪑 空房示例",
    musicRoomEmptyCap: "空房",
    musicRoomEmptyAlt: "空房内部 - 空调、谱架、椅子",
  },
  ja: {
    ...
    printGuideFax: "FAX方法",
    printLangTitle: "🌐 言語設定",
    printLangDesc: "画面上部の地球(🌐)アイコンを押して言語を選択してください。",
    printLangImg1Alt: "言語設定 - 地球アイコンの位置",
    printLangImg2Alt: "言語設定 - 地球アイコンで言語を選択",
    // コピー案内ページ
    copyPageTitle: "📄 コピー案内",
    copyHeroDesc:
      "複合機で書類をコピーする方法です。原稿を正しくセットし、オプションを選んでからお支払いください。",
    copyStepsTitle: "📌 コピーの手順",
    copyStep1:
      "複合機の上面原稿ガラスにコピーする書類を置きます。コピー面を上に向け、ガイドに合わせてください。ホチキスやクリップなどは入れないでください。",
    copyStep2: "複合機の画面で「コピー」ボタンを押します。",
    copyStep3:
      "カラー/白黒、原稿の向き、片面/両面、解像度、部数などを選び、「コピー」を押してスキャンを開始します。",
    copyStep4:
      "お支払い — 画面に支払い内容が出たら「カード決済依頼」を押し、端末でクレジットカード・Samsung Pay・Kakao Pay・Zero Pay・T-moneyなどで支払います。",
    copyStep5: "複合機の排出口からコピーした書類をお取りください。",
    backToPrint: "← プリントショップ案内に戻る",
    // スキャン方法ページ
    scanPageTitle: "スキャン SCAN",
    scanHeroDesc: "複合機で書類をスキャンする方法です。メールスキャンまたはUSBスキャンを選び、設定してからスキャン・お支払いしてください。",
    scanTabEmail: "メールスキャン",
    scanTabUsb: "USBスキャン",
    scanStepsTitle: "📌 スキャンの手順",
    scanEmailStepsTitle: "📌 メールスキャンの手順",
    scanEmailNoticeTitle: "⚠️ 注意事項",
    scanEmailNotice1: "メールアドレスが正しく入力されているか、もう一度ご確認ください。",
    scanEmailNotice2: "会社メールアドレスはファイアウォールやセキュリティ設定により受信できない場合があります。一般メールでも迷惑メールに分類されることがあります。不安な場合は、まず1枚だけテスト送信して確認すると損失を減らせます。",
    scanEmailGuideAlt: "メールスキャン 全体ガイド",
    scanPaperLoadWarn: "スキャンする用紙を複合機の上部にセットしてください。ホチキスなどの異物が入らないようご注意ください。",
    scanPaperLoadAlt: "スキャンする用紙を複合機の上部にセット",
    scanEmailStep2: "複合機の画面で「メールスキャン」を選びます。",
    scanEmailStep2Alt: "メールスキャン 手順2 - メールスキャンを選択",
    scanEmailStep3: "送信先のメールアドレスを入力します。",
    scanEmailStep3Alt: "メールスキャン 手順3 - メールアドレス入力",
    scanEmailStep4: "白黒/カラー、解像度、ファイル形式(PDF/JPG)、片面/両面を設定し、「スキャン(メール)」を押して開始します。",
    scanEmailStep4Alt: "メールスキャン 手順4 - 設定確認してスキャン開始",
    scanEmailStep5: "支払い内容が表示されたら「カード決済依頼」を押し、決済端末で支払います。",
    scanEmailStep5Alt: "メールスキャン 手順5 - カード決済依頼",
    scanEmailStep6: "スキャン後、メール送信を確認してください。（受信まで少し時間がかかる場合があります）",
    scanStep1: "複合機右側のUSBポートにUSBメモリを差します。",
    scanStep2: "複合機の画面で「USBスキャン」ボタンを押します。",
    scanStep3: "白黒/カラー、解像度、原稿の向き、ファイル形式(PDF/JPG)、片面/両面、連続スキャンなどを選び、「スキャン(USB)」を押してスキャンを開始します。",
    scanStep4: "スキャンが終わったら「終了後保存」を選ぶとUSBに保存されます。",
    scanStep5: "支払い内容が表示されたら「カード決済依頼」ボタンを押します。",
    scanStep6: "決済端末でクレジットカード、デビットカード、Zero Pay、Kakao Payなどでお支払いください。",
    // 1番PCダイレクト印刷ページ
    directPageTitle: "🖨 1番PC ダイレクト印刷案内",
    directHeroDesc: "1番PCではお支払い後すぐに印刷されます。PIN番号は不要です。",
    directCheckTitle: "📋 印刷前の確認",
    directCheckLead: "画面に出力リストボックス(CLOPY)が表示されている必要があります。",
    directTrayTitle: "⚠️ 出力リストボックスが表示されない場合",
    directTrayLead: "画面右下の矢印(▲)を押すと隠れたアイコンが表示されます。黄色いアイコン(KSPCCLient)をダブルクリックすると印刷プログラムが再起動します。",
    directStepsTitle: "📌 印刷の手順",
    directStep1: "プログラムで印刷を選び、白黒/カラー等を設定して印刷ボタンをクリックします。",
    directStep2: "出力リストにジョブが表示されます。枚数と金額を確認してください。",
    directStep3: "「出力費用決済/出力」ボタンを押して決済を進めます。",
    directStep4: "お支払い — クレジットカード、Samsung Pay、Kakao Pay、Zero Pay、T-moneyなどで支払います。カードは画面下のスロットに挿入するか、画面にタッチしてください。",
    directStep5: "複合機の排出口から印刷物をお取りください。",
    // 2・3・4番PC PIN番号印刷ページ
    pinPageTitle: "🖨 2・3・4番PC PIN番号印刷案内",
    pinHeroDesc: "2・3・4番PCでは、PCでPIN番号を設定したあと、複合機画面でそのPIN番号を入力して印刷します。ファイルがサーバーにアップロードされ複合機に表示されるまで約1分かかることがあります。",
    pinStepsTitle: "📌 印刷の手順",
    pinStep1: "プログラムで印刷を選び、白黒/カラー等を設定して印刷ボタンを押します。",
    pinStep2: "KAPP Clientの画面に出力リストが表示されます。",
    pinStep3: "「全体送信」を押したあと、5桁以上のPIN番号を入力します。（他の方が使用中の番号は使えない場合があります。使えない場合は番号を変えて再入力してください。）複合機でこのPIN番号で印刷するので、入力した番号を必ず覚えておいてください。",
    pinStep4: "複合機の画面で「印刷」ボタンを押します。",
    pinStep5: "PCで設定したPIN番号を入力し、「確認」を押してください。",
    pinStep6: "PCから送ったファイルが複合機に届くまで少々時間がかかることがあります（1分以内）。「登録されたPin番号がありません」と表示されたら、しばらく待ってから再度お試しください。",
    pinStep7: "複合機に正しく届くと、印刷リストに表示されます。リストを確認して「印刷」を押してください。",
    pinStep8: "お支払い — クレジットカード、Samsung Pay、Kakao Pay、Zero Pay、T-moneyなどで支払います。カードは端末のスロットに挿入するか、画面にタッチしてください。",
    pinStep9: "複合機の排出口から印刷物をお取りください。",
    // FAX方法ページ
    faxPageTitle: "📠 FAX方法",
    faxHeroDesc: "複合機でウェブFAXを使って書類を送る方法です。受信はできず発信のみ可能です。発信番号は02-4073-0798です。",
    faxStepsTitle: "📌 FAXを送る手順",
    faxStep1: "複合機の画面で「ウェブFAX」を選びます。",
    faxStep2: "FAX設定（カラー/白黒、解像度、面、ファイル形式、スキャン方向など）を確認し、「FAX」ボタンを押して送信します。",
    faxStep3: "画面に支払い内容が表示されたら「カード決済依頼」を押して支払いを進めます。",
    faxStep4: "決済端末でクレジットカード、Samsung Pay、Kakao Pay、Zero Pay、T-moneyなどでお支払いください。",
    faxWarnTitle: "⚠️ 案内",
    faxWarn1: "FAXは送信のみ可能で、受信はできません。",
    faxWarn2: "発信番号：02-4073-0798",
    kakaoInquiry: "カトクで問い合わせ",
    kakaoIconText: "トーク",
    visitorTodayLabel: "今日",
    visitorTotalLabel: "総訪問",
    // メイン・ランドリー案内ページ
    ...
    // 音楽練習室
    musicPageTitle: "🎹 音楽練習室ご利用案内",
    musicHeroDesc: "鍵盤ルームと空き室で快適に練習できます。",
    musicRoomTypesTitle: "🪗 ルーム種類",
    musicRoomKeyboard: "鍵盤ルーム – ヤマハピアノタッチ88鍵",
    musicRoomEmpty: "空き室 – 空き練習室（楽器・ボーカルなど自由練習）",
    musicPriceTitle: "💰 料金案内",
    musicPriceLead: "タイム料金とクーポン割引があります。（個人練習基準）",
    musicTimeRate: "タイム料金 – 7,000ウォン",
    musicCouponCol: "クーポン時間",
    musicAmountCol: "料金",
    musicCoupon10: "10時間",
    musicCoupon20: "20時間",
    musicCoupon40: "40時間",
    musicCoupon60: "60時間",
    musicPrice50: "50,000ウォン",
    musicPrice80: "80,000ウォン",
    musicPrice120: "120,000ウォン",
    musicPrice140: "140,000ウォン",
    musicValidNote: "✔ 決済後3ヶ月までご利用可能です。",
    musicBookingTitle: "⚠️ 予約案内",
    musicBookingLead: "管楽器・打楽器は予約が難しい場合があります。利用前にカカオトークでお問い合わせください。",
    musicAmenitiesTitle: "🛋 施設・備品",
    musicAmenityAc: "エアコン",
    musicAmenityChair: "椅子",
    musicAmenityStand: "譜面台",
    musicAmenityAmp: "トルトリ アンプ",
    musicAmenityAmpNote: "（要事前予約）",
    musicAmenityWifi: "Wi‑Fi",
    musicAmenityToilet: "トイレ",
    musicAmenityVent: "換気",
    musicAmenityAlarm: "警報機",
    musicAmenityLock: "ドアロック",
    musicAmenityWater: "浄水器",
    musicStudioMapTitle: "🗺 スタジオ配置図",
    musicStudioMapCap: "スタジオ配置図",
    musicStudioMapAlt: "スタジオ配置 - 1〜4号室、廊下",
    musicInteriorTitle: "🖼 スタジオ内部",
    musicInteriorCap: "スタジオ内部",
    musicInteriorAlt: "スタジオ内部 - 壁、カーテン、吸音、エアコン",
    musicLobbyTitle: "🚪 ロビー / 廊下",
    musicLobbyCap: "ロビー / 廊下",
    musicLobbyAlt: "ロビー・廊下",
    musicRoomEmptyTitle: "🪑 空き室例",
    musicRoomEmptyCap: "空き室",
    musicRoomEmptyAlt: "空き室内部 - エアコン、譜面台、椅子",
  },
};
