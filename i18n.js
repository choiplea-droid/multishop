...
const translations = {
  ko: {
    ...
    scanHeroDesc: "복합기에서 USB로 문서를 스캔하여 저장하는 방법입니다. USB를 꽂은 뒤 화면에서 USB 스캔을 선택하고, 설정 후 스캔·결제하면 됩니다.",
  ...
  en: {
    ...
    scanHeroDesc: "How to scan documents to a USB drive on the MFD. Insert the USB, select USB Scan on the screen, set options, then scan and pay.",
  ...
  zh: {
    ...
    scanHeroDesc: "在复合机上将文档扫描保存到U盘的方法。插入U盘后，在画面选择USB扫描，设置选项后扫描并付款即可。",
    scanStepsTitle: "📌 扫描顺序",
  ...
  ja: {
    ...
    scanHeroDesc: "複合機でUSBに書類をスキャンして保存する方法です。USBを差したら画面でUSBスキャンを選び、設定後にスキャン・お支払いしてください。",
